    ...
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex">
                    <button type="button" class="bg-blue-400 px-4 text-white py-2 rounded-md"
                        wire:click='addingItem()'>Tambah
                        Data Barang</button>
        ...
        <x-jet-dialog-modal wire:model="diskonItem" maxWidth='2xl'>
            ...
            <x-slot name="footer">
                ...
                @else
                <x-jet-danger-button wire:click="hapusDiskon({{ $itemID }})" wire:loading.attr="disabled">
                    Hapus
                </x-jet-danger-button>
                @endif
