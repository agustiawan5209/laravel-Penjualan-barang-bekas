                        ...
                        <tbody>
                            @foreach ($transaksi as $item)
                                <tr>
                                    ...
                                    <x-forms.td>
                                        <span
                                            class="bg-gradient-to-tl from-emerald-500 to-teal-400 px-3.6-em text-size-xs-em rounded-1.8 py-2.2-em inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">{{ $item->payment_status }}</span>
                                        <p
                                            class="mb-0 font-semibold leading-tight dark:text-white dark:opacity-80 text-xs">
                                            {{ $item->payment_type }}</p>
                                    </x-forms.td>
                                    <x-forms.td>
                                        <a href="{{ $item->pdf_url }}" class="px-0">
                        ...
                        <li
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="mb-2 leading-tight text-size-xs dark:text-white/80">Company Name: <span
                                        ...
                                        Burrito</span></span>
                                <span class="mb-2 leading-tight text-size-xs dark:text-white/80">Email Address: <span
                ...
                <div class="flex-auto p-4 pt-6">
                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                       ...
                       <div class="flex items-center">
                           ...
                           <div class="flex flex-col">
                               <h6 class="mb-1 leading-normal dark:text-white text-size-sm text-slate-700">{{$item->user->name}}
                               </h6>
                               <span class="leading-tight text-size-xs dark:text-white/80">{{$item->user->email}}
                                   </span>
                           </div>
                       </div>
