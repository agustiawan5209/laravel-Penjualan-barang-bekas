                        ...
                        <div class="flex flex-col items-start gap-2">
                            <div class="w-20 h-12 flex border rounded overflow-hidden">
                                <input id="total_jumlah" wire:model='jumlah'
                                    class="w-full focus:ring ring-inset text-black ring-indigo-300 outline-none transition duration-100 px-4 py-2"
                                    min="0" max="5" disabled />
                                <div class="flex flex-col border-l divide-y">
                                    <button id="plus" wire:click='Hitung({{ $itemID }})'
                                        class="w-6 flex justify-center items-center flex-1 bg-white hover:bg-gray-100 text-black active:bg-gray-200 leading-none select-none transition duration-100 ">+</button>
                                ...
                                <div class=" col-span-4 border-r border-gray-400">
                                    <div class="px-2 py-2 select-none">
                                        <form action="#" method="post" class="block">
                                            ...
                                            <x-jet-button type='button' wire:click='createUlasan'>Kirim Ulasan
                                            </x-jet-button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                @if ($ulasan->count() > 0)
                                    @foreach ($ulasan as $ulasan)
                                        <div class=" flex flex-col gap-3 py-4 md:py-8">
                                            <div class=" "><span
                                                    class=" block text-sm font-bold">{{ $ulasan->email }}</span><span
                                                    class=" block text-gray-500 text-sm">{{ $ulasan->created_at }}</span>
                                            </div>
                                            <div class=" flex gap-0.5 -ml-1"><span><svg
