<div class="flex flex-wrap -mx-3">
                                            ...
                                            @foreach ($metodeBayar as $item)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <x-jet-secondary-button class="px-2 py-0 text-xs bg-red-500"
                                                        ...
                                                        <x-jet-secondary-button class="px-2 py-0 text-xs"
                                                            wire:click='hapus'>
                                                            <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="w-full max-w-full px-3 mt-6 shrink-0 md:w-4/12 md:flex-0 md:mt-0">
        <div
            ...
            <img class="w-full rounded-t-2xl" src="{{ Auth::user()->profile_photo_url }}" alt="profile cover image object-cover">
