    ...
    <div class="items-center block w-auto max-h-screen  grow basis-full">
        ...
        @can('Manage-Admin')
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" {{ request()->routeIs('Admin.Penjualan') ? 'py-2.7 bg-blue-500/13  text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 underline transition-colors ' : ' py-2.7 text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors' }}"
                        ...
                        <div class="ml-1 duration-300 opacity-100 pointer-events-none ease flex justify-between w-full">
                            <span>Penjualan</span>
                             <span class="text-white bg-red-500 p-1 rounded-xl text-xs">{{ $data['payment'] }}</span>
                            </div>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class=" {{ request()->routeIs('Pembelian-Index') ? 'py-2.7 bg-blue-500/13  text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors' : ' py-2.7 text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors' }}"
                        ...
                        <div class="ml-1 duration-300 opacity-100 pointer-events-none ease flex justify-between w-full">
                            <span>Pembelian</span>
                             <span class="text-white bg-red-500 p-1 rounded-xl text-xs">{{ $data['request'] }}</span>
                            </div>
                    </a>
                </li>
                <li class="mt-0.5 w-full">
                ...
                <li class="mt-0.5 w-full">
                    <a class=" {{ request()->routeIs('chat') ? 'py-2.7 bg-blue-500/13  text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors' : ' py-2.7 text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors' }}"
                        href="{{ route('chat') }}">
                        <div
                            class="mr-2 flex h-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <svg class="w-full h-full text-blue-500" fill="none" stroke="currentColor"
                ...
                {{-- Laporan --}}
                <li class="mt-0.5 w-full" x-data="{ Laporan: false }">
                    <a class="{{ request()->routeIs('laporan-Penjualan') || request()->routeIs('Laporan.Pembelian') || request()->routeIs('Laporan.titipbarang') ? 'py-2.7 bg-blue-500/13  text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors' : ' py-2.7 text-size-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors' }} relative"
                        href="#" x-on:click="Laporan = ! Laporan">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 leading-normal text-blue-500 ni ni-tv-2 text-size-sm"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Laporan Data</span>
                    </a>
                    <ul class=" list-none hover:list-disc bg-blue-500 text-white" x-show="Laporan" x-transition>
                        <li class="mt-0.5 w-full">
