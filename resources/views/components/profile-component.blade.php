                    ...
                    <ul class="relative flex flex-wrap p-1 list-none bg-gray-50 rounded-xl" nav-pills role="tablist">
                        <li class="z-30 flex-auto text-center">
                            <a class="z-30 flex items-center justify-center w-full px-0 py-1 mb-0 transition-all ease-in-out border-0 rounded-lg bg-inherit text-slate-700"
                                nav-link {{request()->routeIs('Customer.Penitipan') ? 'active' : ''}} href="#" role="tab" aria-selected="true" wire:click='Penitipan'>
                                <i class="ni ni-app"></i>
                                <span class="ml-2">Penitipan</span>
                            </a>
                        </li>
                        <li class="z-30 flex-auto text-center">
                            <a class="z-30 flex items-center justify-center w-full px-0 py-1 mb-0 transition-all ease-in-out border-0 rounded-lg bg-inherit text-slate-700"
                                ...
                                @else
                                    <span class="inline-flex rounded-md">
                                        <button type="button"
                                            ...
                                            <svg class="ml-2 -mr-0.5 h-full w-full" xmlns="http://www.w3.org/2000/svg"
