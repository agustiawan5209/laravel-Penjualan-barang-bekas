<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-8 md:mb-12">Barang Terlaris</h2>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
            <div class=""><a href="#"
                    ...
                    <div class="w-full flex flex-col bg-white text-center relative p-4 rounded-global "><span
                            class="text-gray-500">Men</span><span
                            class="text-gray-800 text-lg lg:text-xl font-bold">Business Causual</span></div>
                </a></div>
            <div class=""><a href="#"
                    class="group h-96 flex items-end bg-gray-100 overflow-hidden shadow-lg relative p-4 rounded-global "><img
                        alt="No alt"
                        ...
                        class="w-full h-full object-cover object-center absolute inset-0 group-hover:scale-110 transition duration-200 " />
                    <div class="w-full flex flex-col bg-white text-center relative p-4 rounded-global "><span
                            class="text-gray-500">Women</span><span
                            class="text-gray-800 text-lg lg:text-xl font-bold">Summer Season</span></div>
                </a></div>
            <div class=""><a href="#"
                    class="group h-96 flex items-end bg-gray-100 overflow-hidden shadow-lg relative p-4 rounded-global "><img
                        alt="No alt"
                    ...
                    <div class="w-full flex flex-col bg-white text-center relative p-4 rounded-global "><span
                            class="text-gray-500">Men</span><span
                            class="text-gray-800 text-lg lg:text-xl font-bold">Streetwear</span></div>
                </a></div>
            <div class=""><a href="#"
                    class="group h-96 flex items-end bg-gray-100 overflow-hidden shadow-lg relative p-4 rounded-global "><img
                        alt="No alt"
                    ...
                    <div class="w-full flex flex-col bg-white text-center relative p-4 rounded-global "><span
                            class="text-gray-500">Women</span><span
                            class="text-gray-800 text-lg lg:text-xl font-bold">Sale</span></div>
                </a></div>
        </div>
    </div>
</div>
