<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-8 md:mb-12 wow fadeInRight">Produk Terbaru</h2>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
           @foreach ($barang_terbaru as $item)
             <div class="wow slideInLeft"><a href="{{ route('Produk-list', ['id' => $item->id, 'name' => $item->nama_produk]) }}"
