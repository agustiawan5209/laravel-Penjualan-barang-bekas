<x-guest-layout>
    <div class="w-full  bg-red-500 rounded-l-lg shadow-lg shadow-white transition-all ">
        ...
        @endif
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('Jual-Titip.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                    <label for="dropzone-file"
                        ...
                        <input id="dropzone-file" name='foto' type="file" />
                        </section>
                        @error('foto')
                ...
                <div class="mb-6">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        name="harga_produk" type="text" placeholder="******************">
                    @error('harga_produk')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-6">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        name="deskripsi_produk" type="text" placeholder="******************">
                ...
                <div class="mb-6">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                        name="jumlah_stock" type="text" placeholder="******************">
                    @error('jumlah_stock')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                </div>
