...
<head>
    ...
    <title>Laravel</title>
    <link rel="stylesheet" href="{{asset('build/assets/app.6eebe4a3.css')}}">
            ...
            <div class="relative flex items-center justify-between">
                ...
                <ul class="flex items-center hidden space-x-8 lg:flex">
                    ...
                    <li class=""><a href="{{route('register')}}"
                            class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 shadow-md focus:shadow-outline focus:outline-none bg-primary-500 rounded-global">
                            Daftar </a></li>
                </ul>
                <div class="lg:hidden"><button id="ddDopw"
    ...
    <div class=" dark:bg-gray-900">
        <div class="px-2 py-1 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div class="relative flex items-center justify-center">
                <ul class="flex items-center justify-center w-full space-x-8 lg:flex">
                    <li class=""><a href="#"
        ...
        <div class="py-6 bg-primary">
            <div class="px-4 mx-auto max-w-7xl md:px-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-2">
                    <div class="text-center md:text-left mb-3 md:mb-0"><span
                            class="text-gray-100 font-bold uppercase tracking-widest">Newsletter</span>
                        <p class="text-indigo-200">Subscribe to our newsletter</p>
                    </div>
                    <form class="w-full md:max-w-md flex gap-2"><input
                            class="w-full flex-1 text-white border border-white focus:ring rounded outline-none transition duration-100 px-3 py-2 bg-primary-400 ring-primary-300" /><button
                            id="uauAeA"
                            class="inline-block bg-white hover:bg-gray-100 focus-visible:ring ring-indigo-300 active:text-indigo-600 text-sm font-semibold text-center rounded outline-none transition duration-100 px-8 py-2 text-primary md:text-base ">Send</button>
                    </form>
                </div>
            </div>
        </div>
